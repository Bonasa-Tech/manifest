...
impl MarketFixed {
    ...
    pub fn new_nondet() -> Self {
        ...
        MarketFixed {
            ...
            _padding1: [0; 3],
            base_mint: Pubkey::new_from_array(nondet()),
            quote_mint: Pubkey::new_from_array(nondet()),
            base_vault: Pubkey::new_from_array(nondet()),
            quote_vault: Pubkey::new_from_array(nondet()),
